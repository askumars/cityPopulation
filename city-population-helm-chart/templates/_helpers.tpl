...
helm.sh/chart: {{ include "city-population.chart" . }}
...
*/}}
{{- define "city-population.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "city-population.fullname" .) .Values.serviceAccount.name }}
{{- else }}
